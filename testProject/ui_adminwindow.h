...
public:
    ...
    void setupUi(QMainWindow *AdminWindow)
    {
        ...
        nameDisplay_2->setObjectName(QString::fromUtf8("nameDisplay_2"));
        nameDisplay_2->setGeometry(QRect(530, 0, 241, 17));
        signoutButton_2 = new QPushButton(groupBox);
        signoutButton_2->setObjectName(QString::fromUtf8("signoutButton_2"));
        signoutButton_2->setGeometry(QRect(690, 270, 83, 25));
        accountsButton_2 = new QPushButton(groupBox);
        accountsButton_2->setObjectName(QString::fromUtf8("accountsButton_2"));
