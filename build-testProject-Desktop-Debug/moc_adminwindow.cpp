...
#include <memory>
#include "../testProject/adminwindow.h"
...
QT_MOC_LITERAL(1, 12, 7), // "signOut"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14) // "signOutRequest"

    },
    "AdminWindow\0signOut\0\0signOutRequest"
};
...
void AdminWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AdminWindow::signOut)) {
                *result = 0;
                return;
            }
        }
