...
public:
    ...
    void setupUi(QMainWindow *PatronWindow)
    {
        ...
        catalogueTable = new QTableWidget(cataloguePage);
        catalogueTable->setObjectName(QString::fromUtf8("catalogueTable"));
        catalogueTable->setGeometry(QRect(10, 50, 791, 361));
        ...
        bwCat = new QLabel(cataloguePage);
        bwCat->setObjectName(QString::fromUtf8("bwCat"));
        bwCat->setGeometry(QRect(210, 140, 441, 131));
    ...
    void retranslateUi(QMainWindow *PatronWindow)
    {
        ...
        choldButton->setText(QCoreApplication::translate("PatronWindow", "Place hold", nullptr));
        pholdButton->setText(QCoreApplication::translate("PatronWindow", "Cancel hold", nullptr));
        bwCat->setText(QCoreApplication::translate("PatronWindow", "CATALOGUE LIST DISPLAY HERE", nullptr));
